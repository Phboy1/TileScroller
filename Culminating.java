...
public class Culminating extends Canvas implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void mouseWheelMoved(MouseWheelEvent e)
    {
        if (state == MENU)
        {
            menuScroll += e.getWheelRotation() * SCROLL_SPEED;
    ...
    public static void drawMouseMovement(Graphics2D g2d)
    {
        ...
        if (tileY/TILE_SIZE < 0 || tileY/TILE_SIZE >= currentRows || tileX/TILE_SIZE < 0 || tileX/TILE_SIZE >= currentCols) return;
        ...
        if (clicked)
        {
            map[tileY/TILE_SIZE][tileX/TILE_SIZE] = new Tile(tileX, tileY, TILE_SIZE, EDITOR_TILES[editorTileIndex]);
        }
    }
